#Two container setup
#one container for mysql db
#one container for interation with mysql db
#we will use docker network for interation
...
def create_connection():
    return pymysql.connect(
        host="mysqldb",  # Your MySQL server host....."mysqldb" is docker container name that hosts the MYSQL DB
